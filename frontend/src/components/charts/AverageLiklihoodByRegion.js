...
const AverageLikelihoodByRegion = ({ data }) => {
  ...
  return (
    <div className="px-6 py-6 border border-gray-400 rounded-lg shadow-md bg-white flex flex-col justify-center items-center">
      <div className="w-full flex justify-between items-center mb-6">
        <h1 className="text-2xl font-semibold text-gray-900">Average Likelihood by Region</h1>
